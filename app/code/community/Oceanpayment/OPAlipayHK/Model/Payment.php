 ...
 */
class Oceanpayment_OPAlipayHK_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_alipayhk';
    protected $_formBlockType = 'opalipayhk/form';
    ...
    // AlipayHK return codes of payment
     ...
     */
    public function getAlipayHKUrl()
    {
	...
	{
		return Mage::getUrl('opalipayhk/payment/return', array('_secure' => true,'_nosid' => true));
	}

	/**
	 *  Return URL for AlipayHK success response
	 *
	 *  @return	  string URL
	 */
    ...
    /**
     *  Return URL for AlipayHK failure response
     *
     *  @return	  string URL
     */
    protected function getErrorURL()
    {
        return Mage::getUrl('opalipayhk/payment/error', array('_secure' => true));
    }

	/**
	 *  Return URL for AlipayHK notify response
	 *
	 *  @return	  string URL
	 */
	protected function getNoticeURL()
	{
		return Mage::getUrl('opalipayhk/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('opalipayhk/form', $name);
    ...
    {
        return Mage::getUrl('opalipayhk/payment/redirect', array('_secure' => true));
    }

    /**
     *  Return Standard Checkout Form Fields for request to AlipayHK
     *
	...
	/**
	 * Return authorized languages by AlipayHK
	 *
	 * @param	none
	 * @return	array
	 */
	protected function _getAuthorizedLanguages()
	{
        ...
        foreach (Mage::getConfig()->getNode('global/payment/alipayhk_payment/languages')->asArray() as $data) 
		{
	...
	/**
	 * Return language code to send to AlipayHK
	 *
	 * @param	none
	 * @return	String
	 */
    ...
    /**
     *  Return response for AlipayHK success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for AlipayHK failure payment
     *
     *  @param    none
