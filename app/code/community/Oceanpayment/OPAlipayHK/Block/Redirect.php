 ...
 */
class Oceanpayment_OPAlipayHK_Block_Redirect extends Mage_Core_Block_Template
{
	/**
	 * Order instance
	 */
	...
	protected function _toHtml()
	{
		...
		//是否开启内嵌支付
		if($pay_mode == 1){
			$this->setTemplate('op_alipayhk/redirect.phtml');
		}else{
			$this->setTemplate('op_alipayhk/jumpredirect.phtml');
		}
	...
	protected function creditCardForm()
	{
        ...
        $form->setAction($standard->getAlipayHKUrl())
            ->setId('alipayhk_payment_checkout')
            ->setName('alipayhk_payment_checkout')
            ->setMethod('POST')
