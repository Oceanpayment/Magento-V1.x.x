 ...
 */
class Oceanpayment_OPPrzelewy24_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_przelewy24';
    protected $_formBlockType = 'opprzelewy24/form';

    // Przelewy24 return codes of payment
     ...
     */
    public function getPrzelewy24Url()
    {
	...
	{
		return Mage::getUrl('opprzelewy24/payment/return', array('_secure' => true,'_nosid' => true));
	}

	/**
	 *  Return URL for Przelewy24 success response
	 *
	 *  @return	  string URL
	 */
    ...
    /**
     *  Return URL for Przelewy24 failure response
     *
     *  @return	  string URL
     */
    protected function getErrorURL()
    {
        return Mage::getUrl('opprzelewy24/payment/error', array('_secure' => true));
    }

	/**
	 *  Return URL for Przelewy24 notify response
	 *
	 *  @return	  string URL
	 */
	protected function getNoticeURL()
	{
		return Mage::getUrl('opprzelewy24/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('opprzelewy24/form_payment', $name);
    ...
    {
        return Mage::getUrl('opprzelewy24/payment/redirect', array('_secure' => true));
    }

    /**
     *  Return Standard Checkout Form Fields for request to Przelewy24
     *
	...
	/**
	 * Return authorized languages by Przelewy24
	 *
	 * @param	none
	 * @return	array
	 */
	protected function _getAuthorizedLanguages()
	{
        ...
        foreach (Mage::getConfig()->getNode('global/payment/przelewy24_payment/languages')->asArray() as $data) 
		{
	...
	/**
	 * Return language code to send to Przelewy24
	 *
	 * @param	none
	 * @return	String
	 */
    ...
    /**
     *  Return response for Przelewy24 success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for Przelewy24 failure payment
     *
     *  @param    none
