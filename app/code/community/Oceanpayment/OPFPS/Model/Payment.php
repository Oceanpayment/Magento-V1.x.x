 ...
 */
class Oceanpayment_OPFPS_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_fps';
    protected $_formBlockType = 'opfps/form';
	...
	{
		return Mage::getUrl('opfps/payment/return', array('_secure' => true,'_nosid' => true));
	}

	/**
	 *  Return URL for FPS success response
	 *
	 *  @return	  string URL
	 */
    ...
    /**
     *  Return URL for FPS failure response
     *
     *  @return	  string URL
     */
    protected function getErrorURL()
    {
        return Mage::getUrl('opfps/payment/error', array('_secure' => true));
    }

	/**
	 *  Return URL for FPS notify response
	 *
	 *  @return	  string URL
	 */
	protected function getNoticeURL()
	{
		return Mage::getUrl('opfps/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('opfps/form', $name);
    ...
    {
        return Mage::getUrl('opfps/payment/redirect', array('_secure' => true));
    }

    /**
     *  Return Standard Checkout Form Fields for request to FPS
     *
	...
	/**
	 * Return authorized languages by FPS
	 *
	 * @param	none
	 * @return	array
	 */
	protected function _getAuthorizedLanguages()
	{
        ...
        foreach (Mage::getConfig()->getNode('global/payment/fps_payment/languages')->asArray() as $data) 
		{
	...
	/**
	 * Return language code to send to FPS
	 *
	 * @param	none
	 * @return	String
	 */
    ...
    /**
     *  Return response for FPS success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for FPS failure payment
     *
     *  @param    none
