 ...
 */
class Oceanpayment_OPFPS_Block_Redirect extends Mage_Core_Block_Template
{
	/**
	 * Order instance
	 */
	...
	protected function _toHtml()
	{
		...
		//是否开启内嵌支付
		if($pay_mode == 1){
			$this->setTemplate('op_fps/redirect.phtml');
		}else{
			$this->setTemplate('op_fps/jumpredirect.phtml');
		}
	...
	protected function creditCardForm()
	{
        ...
        $form->setAction($standard->getFPSUrl())
            ->setId('fps_payment_checkout')
            ->setName('fps_payment_checkout')
            ->setMethod('POST')
