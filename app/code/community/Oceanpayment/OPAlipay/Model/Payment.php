 ...
 */
class Oceanpayment_OPAlipay_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_alipay';
    protected $_formBlockType = 'opalipay/form';
	...
	{
		return Mage::getUrl('opalipay/payment/return', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        return Mage::getUrl('opalipay/payment/error', array('_secure' => true));
    }
	...
	{
		return Mage::getUrl('opalipay/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('opalipay/form_payment', $name);
    ...
    {
        return Mage::getUrl('opalipay/payment/redirect', array('_secure' => true));
    }
    ...
    public function getStandardCheckoutFormFields()
    {
		...
		$parameter['cart_info']			= 'Magento 1.x|V1.9.1 Alipay|'.$isMobile;
		//接口版本
		$parameter['cart_api']			= '';
		//校验源字符串
