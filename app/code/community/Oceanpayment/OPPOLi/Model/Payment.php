 ...
 */
class Oceanpayment_OPPOLi_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_poli';
    protected $_formBlockType = 'oppoli/form';

    // POLi return codes of payment
	...
	{
		return Mage::getUrl('oppoli/payment/return', array('_secure' => true,'_nosid' => true));
	}

	/**
	 *  Return URL for POLi success response
	 *
	 *  @return	  string URL
	 */
    ...
    /**
     *  Return URL for POLi failure response
     *
     *  @return	  string URL
     */
    protected function getErrorURL()
    {
        return Mage::getUrl('oppoli/payment/error', array('_secure' => true));
    }

	/**
	 *  Return URL for POLi notify response
	 *
	 *  @return	  string URL
	 */
	protected function getNoticeURL()
	{
		return Mage::getUrl('oppoli/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('oppoli/form_payment', $name);
    ...
    {
        return Mage::getUrl('oppoli/payment/redirect', array('_secure' => true));
    }

    /**
     *  Return Standard Checkout Form Fields for request to POLi
     *
    ...
    public function getStandardCheckoutFormFields()
    {
		...
		//POLi额外字段
		$pay_countryCode   = isset($_SESSION['pay_countryCode'])? $_SESSION['pay_countryCode']: '';
	...
	/**
	 * Return authorized languages by POLi
	 *
	 * @param	none
	 * @return	array
	 */
	protected function _getAuthorizedLanguages()
	{
        ...
        foreach (Mage::getConfig()->getNode('global/payment/poli_payment/languages')->asArray() as $data) 
		{
	...
	/**
	 * Return language code to send to POLi
	 *
	 * @param	none
	 * @return	String
	 */
    ...
    /**
     *  Return response for POLi success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for POLi failure payment
     *
     *  @param    none
