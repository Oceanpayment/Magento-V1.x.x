 ...
 */
class Oceanpayment_OPUnionPay_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_unionpay';
    protected $_formBlockType = 'opunionpay/form';
	...
	{
		return Mage::getUrl('opunionpay/payment/return', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        return Mage::getUrl('opunionpay/payment/error', array('_secure' => true));
    }
	...
	{
		return Mage::getUrl('opunionpay/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('opunionpay/form', $name);
    ...
    {
        return Mage::getUrl('opunionpay/payment/redirect', array('_secure' => true));
    }
    ...
    /**
     *  Return response for UnionPay success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for UnionPay failure payment
     *
     *  @param    none
