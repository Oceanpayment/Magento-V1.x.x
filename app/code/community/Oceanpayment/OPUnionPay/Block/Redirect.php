 ...
 */
class Oceanpayment_OPUnionPay_Block_Redirect extends Mage_Core_Block_Template
{
	/**
	 * Order instance
	 */
	...
	protected function _toHtml()
	{
		...
		//是否开启内嵌支付
		if($pay_mode == 1){
			$this->setTemplate('op_unionpay/redirect.phtml');
		}else{
			$this->setTemplate('op_unionpay/jumpredirect.phtml');
		}
	...
	protected function unionPayForm()
	{
