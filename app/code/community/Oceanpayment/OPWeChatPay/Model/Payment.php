 ...
 */
class Oceanpayment_OPWeChatPay_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_wechatpay';
    protected $_formBlockType = 'opwechatpay/form';
    ...
    // WeChatPay return codes of payment
     ...
     */
    public function getWeChatPayUrl()
    {
	...
	{
		return Mage::getUrl('opwechatpay/payment/return', array('_secure' => true,'_nosid' => true));
	}

	/**
	 *  Return URL for WeChatPay success response
	 *
	 *  @return	  string URL
	 */
    ...
    /**
     *  Return URL for WeChatPay failure response
     *
     *  @return	  string URL
     */
    protected function getErrorURL()
    {
        return Mage::getUrl('opwechatpay/payment/error', array('_secure' => true));
    }

	/**
	 *  Return URL for WeChatPay notify response
	 *
	 *  @return	  string URL
	 */
	protected function getNoticeURL()
	{
		return Mage::getUrl('opwechatpay/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('opwechatpay/form_payment', $name);
    ...
    {
        return Mage::getUrl('opwechatpay/payment/redirect', array('_secure' => true));
    }

    
    /**
     *  Return Standard Checkout Form Fields for request to WeChatPay
     *
    ...
    public function getStandardCheckoutFormFields()
    {
		...
		$parameter['cart_info']			= 'Magento 1.x|V1.9.1 WeChatPay|'.$isMobile;
		//接口版本
		$parameter['cart_api']			= '';
		//校验源字符串
	...
	/**
	 * Return authorized languages by WeChatPay
	 *
	 * @param	none
	 * @return	array
	 */
	protected function _getAuthorizedLanguages()
	{
        ...
        foreach (Mage::getConfig()->getNode('global/payment/wechatpay_payment/languages')->asArray() as $data) 
		{
	...
	/**
	 * Return language code to send to WeChatPay
	 *
	 * @param	none
	 * @return	String
	 */
    ...
    /**
     *  Return response for WeChatPay success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for WeChatPay failure payment
     *
     *  @param    none
