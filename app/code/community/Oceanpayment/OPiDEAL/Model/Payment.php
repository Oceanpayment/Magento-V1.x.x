 ...
 */
class Oceanpayment_OPiDEAL_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_ideal';
    protected $_formBlockType = 'opideal/form';

    // iDEAL return codes of payment
	...
	{
		return Mage::getUrl('opideal/payment/return', array('_secure' => true,'_nosid' => true));
	}

	/**
	 *  Return URL for iDEAL success response
	 *
	 *  @return	  string URL
	 */
    ...
    /**
     *  Return URL for iDEAL failure response
     *
     *  @return	  string URL
     */
    protected function getErrorURL()
    {
        return Mage::getUrl('opideal/payment/error', array('_secure' => true));
    }

	/**
	 *  Return URL for iDEAL notify response
	 *
	 *  @return	  string URL
	 */
	protected function getNoticeURL()
	{
		return Mage::getUrl('opideal/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('opideal/form_payment', $name);
    ...
    {
        return Mage::getUrl('opideal/payment/redirect', array('_secure' => true));
    }

    /**
     *  Return Standard Checkout Form Fields for request to iDEAL
     *
	...
	/**
	 * Return authorized languages by iDEAL
	 *
	 * @param	none
	 * @return	array
	 */
	protected function _getAuthorizedLanguages()
	{
        ...
        foreach (Mage::getConfig()->getNode('global/payment/ideal_payment/languages')->asArray() as $data) 
		{
	...
	/**
	 * Return language code to send to iDEAL
	 *
	 * @param	none
	 * @return	String
	 */
    ...
    /**
     *  Return response for iDEAL success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for iDEAL failure payment
     *
     *  @param    none
