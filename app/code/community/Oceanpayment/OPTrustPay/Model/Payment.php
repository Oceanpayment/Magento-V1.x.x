 ...
 */
class Oceanpayment_OPTrustPay_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_trustpay';
    protected $_formBlockType = 'optrustpay/form';

    // TrustPay return codes of payment
     ...
     */
    public function getTrustPayUrl()
    {
	...
	{
		return Mage::getUrl('optrustpay/payment/return', array('_secure' => true,'_nosid' => true));
	}

	/**
	 *  Return URL for TrustPay success response
	 *
	 *  @return	  string URL
	 */
    ...
    /**
     *  Return URL for TrustPay failure response
     *
     *  @return	  string URL
     */
    protected function getErrorURL()
    {
        return Mage::getUrl('optrustpay/payment/error', array('_secure' => true));
    }

	/**
	 *  Return URL for TrustPay notify response
	 *
	 *  @return	  string URL
	 */
	protected function getNoticeURL()
	{
		return Mage::getUrl('optrustpay/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('optrustpay/form_payment', $name);
    ...
    {
        return Mage::getUrl('optrustpay/payment/redirect', array('_secure' => true));
    }

    /**
     *  Return Standard Checkout Form Fields for request to TrustPay
     *
    ...
    public function getStandardCheckoutFormFields()
    {
		...
		$billing_zip       = $billing->getPostcode() != '' ? $billing->getPostcode(): '999999';		
		//收货人地址信息
		//收货人名
		...
		//TrustPay额外字段
		$pay_countryCode   = isset($_SESSION['optrustpay_pay_countryCode'])? $_SESSION['optrustpay_pay_countryCode']: '';

		//清空trustpay专有session
		unset($_SESSION['optrustpay_pay_countryCode']);
	...
	/**
	 * Return authorized languages by TrustPay
	 *
	 * @param	none
	 * @return	array
	 */
	protected function _getAuthorizedLanguages()
	{
        ...
        foreach (Mage::getConfig()->getNode('global/payment/trustpay_payment/languages')->asArray() as $data) 
		{
	...
	/**
	 * Return language code to send to TrustPay
	 *
	 * @param	none
	 * @return	String
	 */
    ...
    /**
     *  Return response for TrustPay success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for TrustPay failure payment
     *
     *  @param    none
