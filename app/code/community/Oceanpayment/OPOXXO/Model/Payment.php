 ...
 */
class Oceanpayment_OPOXXO_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_oxxo';
    protected $_formBlockType = 'opoxxo/form';
	...
	{
		return Mage::getUrl('opoxxo/payment/return', array('_secure' => true,'_nosid' => true));
	}

	/**
	 *  Return URL for OXXO success response
	 *
	 *  @return	  string URL
	 */
    ...
    /**
     *  Return URL for OXXO failure response
     *
     *  @return	  string URL
     */
    protected function getErrorURL()
    {
        return Mage::getUrl('opoxxo/payment/error', array('_secure' => true));
    }

	/**
	 *  Return URL for OXXO notify response
	 *
	 *  @return	  string URL
	 */
	protected function getNoticeURL()
	{
		return Mage::getUrl('opoxxo/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('opoxxo/form_payment', $name);
    ...
    {
        return Mage::getUrl('opoxxo/payment/redirect', array('_secure' => true));
    }

    
    /**
     *  Return Standard Checkout Form Fields for request to OXXO
     *
    ...
    public function getStandardCheckoutFormFields()
    {
		...
		$parameter['cart_info']			= 'Magento 1.x|V1.9.1 OXXO|'.$isMobile;
		//接口版本
		$parameter['cart_api']			= '';
		//校验源字符串
	...
	/**
	 * Return authorized languages by OXXO
	 *
	 * @param	none
	 * @return	array
	 */
	protected function _getAuthorizedLanguages()
	{
        ...
        foreach (Mage::getConfig()->getNode('global/payment/oxxo_payment/languages')->asArray() as $data) 
		{
	...
	/**
	 * Return language code to send to OXXO
	 *
	 * @param	none
	 * @return	String
	 */
    ...
    /**
     *  Return response for OXXO success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for OXXO failure payment
     *
     *  @param    none
