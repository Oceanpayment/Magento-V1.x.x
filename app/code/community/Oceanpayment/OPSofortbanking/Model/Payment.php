 ...
 */
class Oceanpayment_OPSofortbanking_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_sofortbanking';
    protected $_formBlockType = 'opsofortbanking/form';

    // Sofortbanking return codes of payment
     ...
     */
    public function getSofortbankingUrl()
    {
	...
	{
		return Mage::getUrl('opsofortbanking/payment/return', array('_secure' => true,'_nosid' => true));
	}

	/**
	 *  Return URL for Sofortbanking success response
	 *
	 *  @return	  string URL
	 */
    ...
    /**
     *  Return URL for Sofortbanking failure response
     *
     *  @return	  string URL
     */
    protected function getErrorURL()
    {
        return Mage::getUrl('opsofortbanking/payment/error', array('_secure' => true));
    }

	/**
	 *  Return URL for Sofortbanking notify response
	 *
	 *  @return	  string URL
	 */
	protected function getNoticeURL()
	{
		return Mage::getUrl('opsofortbanking/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('opsofortbanking/form_payment', $name);
    ...
    {
        return Mage::getUrl('opsofortbanking/payment/redirect', array('_secure' => true));
    }

    /**
     *  Return Standard Checkout Form Fields for request to Sofortbanking
     *
	...
	/**
	 * Return authorized languages by Sofortbanking
	 *
	 * @param	none
	 * @return	array
	 */
	protected function _getAuthorizedLanguages()
	{
        ...
        foreach (Mage::getConfig()->getNode('global/payment/sofortbanking_payment/languages')->asArray() as $data) 
		{
	...
	/**
	 * Return language code to send to Sofortbanking
	 *
	 * @param	none
	 * @return	String
	 */
    ...
    /**
     *  Return response for Sofortbanking success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for Sofortbanking failure payment
     *
     *  @param    none
