 ...
 */
class Oceanpayment_OPGiropay_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_giropay';
    protected $_formBlockType = 'opgiropay/form';

    // Giropay return codes of payment
	...
	{
		return Mage::getUrl('opgiropay/payment/return', array('_secure' => true,'_nosid' => true));
	}

	/**
	 *  Return URL for Giropay success response
	 *
	 *  @return	  string URL
	 */
    ...
    /**
     *  Return URL for Giropay failure response
     *
     *  @return	  string URL
     */
    protected function getErrorURL()
    {
        return Mage::getUrl('opgiropay/payment/error', array('_secure' => true));
    }

	/**
	 *  Return URL for Giropay notify response
	 *
	 *  @return	  string URL
	 */
	protected function getNoticeURL()
	{
		return Mage::getUrl('opgiropay/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('opgiropay/form_payment', $name);
    ...
    {
        return Mage::getUrl('opgiropay/payment/redirect', array('_secure' => true));
    }

    /**
     *  Return Standard Checkout Form Fields for request to Giropay
     *
	...
	/**
	 * Return authorized languages by Giropay
	 *
	 * @param	none
	 * @return	array
	 */
	protected function _getAuthorizedLanguages()
	{
        ...
        foreach (Mage::getConfig()->getNode('global/payment/giropay_payment/languages')->asArray() as $data) 
		{
	...
	/**
	 * Return language code to send to Giropay
	 *
	 * @param	none
	 * @return	String
	 */
    ...
    /**
     *  Return response for Giropay success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for Giropay failure payment
     *
     *  @param    none
