 ...
 */
class Oceanpayment_OPInstantTransfer_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_instanttransfer';
    protected $_formBlockType = 'opinstanttransfer/form';

    // InstantTransfer return codes of payment
     ...
     */
    public function getInstantTransferUrl()
    {
	...
	{
		return Mage::getUrl('opinstanttransfer/payment/return', array('_secure' => true,'_nosid' => true));
	}

	/**
	 *  Return URL for InstantTransfer success response
	 *
	 *  @return	  string URL
	 */
    ...
    /**
     *  Return URL for InstantTransfer failure response
     *
     *  @return	  string URL
     */
    protected function getErrorURL()
    {
        return Mage::getUrl('opinstanttransfer/payment/error', array('_secure' => true));
    }

	/**
	 *  Return URL for InstantTransfer notify response
	 *
	 *  @return	  string URL
	 */
	protected function getNoticeURL()
	{
		return Mage::getUrl('opinstanttransfer/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('opinstanttransfer/form_payment', $name);
    ...
    {
        return Mage::getUrl('opinstanttransfer/payment/redirect', array('_secure' => true));
    }

    /**
     *  Return Standard Checkout Form Fields for request to InstantTransfer
     *
	...
	/**
	 * Return authorized languages by InstantTransfer
	 *
	 * @param	none
	 * @return	array
	 */
	protected function _getAuthorizedLanguages()
	{
        ...
        foreach (Mage::getConfig()->getNode('global/payment/instanttransfer_payment/languages')->asArray() as $data) 
		{
	...
	/**
	 * Return language code to send to InstantTransfer
	 *
	 * @param	none
	 * @return	String
	 */
    ...
    /**
     *  Return response for InstantTransfer success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for InstantTransfer failure payment
     *
     *  @param    none
