 ...
 */
class Oceanpayment_OPQiwi_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_qiwi';
    protected $_formBlockType = 'opqiwi/form';

    // Qiwi return codes of payment
	...
	{
		return Mage::getUrl('opqiwi/payment/return', array('_secure' => true,'_nosid' => true));
	}

	/**
	 *  Return URL for Qiwi success response
	 *
	 *  @return	  string URL
	 */
    ...
    /**
     *  Return URL for Qiwi failure response
     *
     *  @return	  string URL
     */
    protected function getErrorURL()
    {
        return Mage::getUrl('opqiwi/payment/error', array('_secure' => true));
    }

	/**
	 *  Return URL for Qiwi notify response
	 *
	 *  @return	  string URL
	 */
	protected function getNoticeURL()
	{
		return Mage::getUrl('opqiwi/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('opqiwi/form_payment', $name);
    ...
    {
        return Mage::getUrl('opqiwi/payment/redirect', array('_secure' => true));
    }
    ...
    public function assignData($data)
    {
    	...
    	$pay_countryCode = $data->getData('pay_countryCode');
    	...
    	Mage::getSingleton('checkout/session')->addData($date);
    
    }
    
    
    /**
     *  Return Standard Checkout Form Fields for request to Qiwi
     *
    ...
    public function getStandardCheckoutFormFields()
    {
		...
		//qiwi 国家代码
		$pay_countryCode   = $session->getData('pay_countryCode') != '' ? $session->getData('pay_countryCode') : '';
		//qiwi 手机号码
	...
	/**
	 * Return authorized languages by Qiwi
	 *
	 * @param	none
	 * @return	array
	 */
	protected function _getAuthorizedLanguages()
	{
        ...
        foreach (Mage::getConfig()->getNode('global/payment/qiwi_payment/languages')->asArray() as $data) 
		{
	...
	/**
	 * Return language code to send to Qiwi
	 *
	 * @param	none
	 * @return	String
	 */
    ...
    /**
     *  Return response for Qiwi success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for Qiwi failure payment
     *
     *  @param    none
