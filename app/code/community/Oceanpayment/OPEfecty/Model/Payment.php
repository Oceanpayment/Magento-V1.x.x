 ...
 */
class Oceanpayment_OPEfecty_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_efecty';
    protected $_formBlockType = 'opefecty/form';
    ...
    // Efecty return codes of payment
	...
	{
		return Mage::getUrl('opefecty/payment/return', array('_secure' => true,'_nosid' => true));
	}

	/**
	 *  Return URL for Efecty success response
	 *
	 *  @return	  string URL
	 */
    ...
    /**
     *  Return URL for Efecty failure response
     *
     *  @return	  string URL
     */
    protected function getErrorURL()
    {
        return Mage::getUrl('opefecty/payment/error', array('_secure' => true));
    }

	/**
	 *  Return URL for Efecty notify response
	 *
	 *  @return	  string URL
	 */
	protected function getNoticeURL()
	{
		return Mage::getUrl('opefecty/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('opefecty/form_payment', $name);
    ...
    {
        return Mage::getUrl('opefecty/payment/redirect', array('_secure' => true));
    }

    
    /**
     *  Return Standard Checkout Form Fields for request to Efecty
     *
    ...
    public function getStandardCheckoutFormFields()
    {
		...
		$parameter['cart_info']			= 'Magento 1.x|V1.9.1 Efecty|'.$isMobile;
		//接口版本
		$parameter['cart_api']			= '';
		//校验源字符串
		...
		//附加参数
		$parameter['pay_bankCode']		= "EY";
		//附加参数
		$parameter['pay_countryCode']	= "CO";
		//附加参数
		$parameter['pay_cpf']			= $this->random(10);
	...
	/**
	 * Return authorized languages by Efecty
	 *
	 * @param	none
	 * @return	array
	 */
	protected function _getAuthorizedLanguages()
	{
        ...
        foreach (Mage::getConfig()->getNode('global/payment/efecty_payment/languages')->asArray() as $data) 
		{
	...
	/**
	 * Return language code to send to Efecty
	 *
	 * @param	none
	 * @return	String
	 */
    ...
    /**
     *  Return response for Efecty success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for Efecty failure payment
     *
     *  @param    none
