 ...
 */
class Oceanpayment_OPBROnlineBank_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_bronlinebank';
    protected $_formBlockType = 'opbronlinebank/form';

    // BROnlineBank return codes of payment
     ...
     */
    public function getBROnlineBankUrl()
    {
	...
	{
		return Mage::getUrl('opbronlinebank/payment/return', array('_secure' => true,'_nosid' => true));
	}

	/**
	 *  Return URL for BROnlineBank success response
	 *
	 *  @return	  string URL
	 */
    ...
    /**
     *  Return URL for BROnlineBank failure response
     *
     *  @return	  string URL
     */
    protected function getErrorURL()
    {
        return Mage::getUrl('opbronlinebank/payment/error', array('_secure' => true));
    }

	/**
	 *  Return URL for BROnlineBank notify response
	 *
	 *  @return	  string URL
	 */
	protected function getNoticeURL()
	{
		return Mage::getUrl('opbronlinebank/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('opbronlinebank/form_payment', $name);
    ...
    {
        return Mage::getUrl('opbronlinebank/payment/redirect', array('_secure' => true));
    }

    /**
     *  Return Standard Checkout Form Fields for request to BROnlineBank
     *
    ...
    public function getStandardCheckoutFormFields()
    {
		...
		//bronlinebank 国家代码
		$pay_bankCode      = isset($_SESSION['opbronlinebank_pay_bankCode']) ? $_SESSION['opbronlinebank_pay_bankCode'] : '';
		//bronlinebank 手机号码
		$pay_cpf           = isset($_SESSION['opbronlinebank_pay_cpf']) ? $_SESSION['opbronlinebank_pay_cpf'] : '';
		//bronlinebank 国家代码
		$pay_countryCode   = 'BR';
		
		//清空bronlinebank专有session
		unset($_SESSION['opbronlinebank_pay_bankCode']);
		unset($_SESSION['opbronlinebank_pay_cpf']);
	...
	/**
	 * Return authorized languages by BROnlineBank
	 *
	 * @param	none
	 * @return	array
	 */
	protected function _getAuthorizedLanguages()
	{
        ...
        foreach (Mage::getConfig()->getNode('global/payment/bronlinebank_payment/languages')->asArray() as $data) 
		{
	...
	/**
	 * Return language code to send to BROnlineBank
	 *
	 * @param	none
	 * @return	String
	 */
    ...
    /**
     *  Return response for BROnlineBank success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for BROnlineBank failure payment
     *
     *  @param    none
